...
### Заливка файлов в бакет через консоль
Файлы можно выгружать в бакет использую терминал и менеджер `mcli`. Для этого выполните команду ниже с названием целевого файла:

```shell
mcli cp <название_файла_с_расширением> local/fastai-html/
```
